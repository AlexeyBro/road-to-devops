...
Создать линк на папку/файл

```bash
ln -s {path_folder/file} {link_name}
```

Создать линк-дубликат файла, особенность в том что при изменении оригинала или
дубликата оба файла будут меняться, удобно например для сохранения копий важной
инфы
